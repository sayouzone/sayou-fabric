...
- Data pipeline orchestration for RAG systems
- Preprocessing and enrichment for enterprise data lakes
- Modular knowledge graph or document indexing systems
- Hybrid local/remote LLM integration pipelines