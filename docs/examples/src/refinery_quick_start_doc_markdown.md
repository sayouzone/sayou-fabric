!!! abstract "Source"
    Synced from [`packages/sayou-refinery/examples/quick_start_doc_markdown.py`](https://github.com/sayouzone/sayou-fabric/blob/main/packages/sayou-refinery/examples/quick_start_doc_markdown.py).
