!!! abstract "Source"
    Synced from [`packages/sayou-assembler/examples/quick_start_timeline.py`](https://github.com/sayouzone/sayou-fabric/blob/main/packages/sayou-assembler/examples/quick_start_timeline.py).
