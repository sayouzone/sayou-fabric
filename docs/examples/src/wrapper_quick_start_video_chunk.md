!!! abstract "Source"
    Synced from [`packages/sayou-wrapper/examples/quick_start_video_chunk.py`](https://github.com/sayouzone/sayou-fabric/blob/main/packages/sayou-wrapper/examples/quick_start_video_chunk.py).
