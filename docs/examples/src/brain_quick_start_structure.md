!!! abstract "Source"
    Synced from [`packages/sayou-brain/examples/quick_start_structure.py`](https://github.com/sayouzone/sayou-fabric/blob/main/packages/sayou-brain/examples/quick_start_structure.py).
