!!! abstract "Source"
    Synced from [`packages/sayou-chunking/examples/quick_start_go.py`](https://github.com/sayouzone/sayou-fabric/blob/main/packages/sayou-chunking/examples/quick_start_go.py).
