!!! abstract "Source"
    Synced from [`packages/sayou-refinery/examples/quick_start_processors.py`](https://github.com/sayouzone/sayou-fabric/blob/main/packages/sayou-refinery/examples/quick_start_processors.py).
