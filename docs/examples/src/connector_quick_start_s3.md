!!! abstract "Source"
    Synced from [`packages/sayou-connector/examples/quick_start_s3.py`](https://github.com/sayouzone/sayou-fabric/blob/main/packages/sayou-connector/examples/quick_start_s3.py).
