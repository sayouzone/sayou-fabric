!!! abstract "Source"
    Synced from [`packages/sayou-document/examples/quick_start_pdf.py`](https://github.com/sayouzone/sayou-fabric/blob/main/packages/sayou-document/examples/quick_start_pdf.py).
