...
class BaseStatus(Enum):
    def __new__(cls, code: int, display_name: str, url: str, desc: str):
    ...
    @classmethod
    def description_by_code(cls, code: int) -> Optional[str]:
        """코드로 설명 조회"""
        member = cls.from_value(code)
        return member.description if member else None
...
# 공시정보
class DisclosureStatus(BaseStatus):
    DISCLOSURE_SEARCH = (
        1,
        "공시검색",
        f"{API_URL}/list.json",
    ...
    COMPANY_INFORMATION = (
        2,
        "기업개황",
        f"{API_URL}/company.json",
        "DART에 등록되어있는 기업의 개황정보를 제공합니다.",
    )
    DOCUMENT = (
        3,
        "공시서류원본파일",
        f"{API_URL}/document.xml",
        "공시보고서 원본파일을 제공합니다.",
    )
    CORP_CODE = (
        4,
        "고유번호",
        f"{API_URL}/corpCode.xml",
...
class OwnershipStatus(BaseStatus):
    MAJOR_OWNERSHIP = (
        1,
        "대량보유 상황보고",
        f"{API_URL}/majorstock.json",
        "주식등의 대량보유상황보고서 내에 대량보유 상황보고 정보를 제공합니다.",
    )
    INSIDER_OWNERSHIP = (
        2,
        "임원ㆍ주요주주 소유보고",
        f"{API_URL}/elestock.json",
...
class MaterialFactStatus(BaseStatus):
    PUT_OPTION = (
        1,
        "자산양수도(기타), 풋백옵션",
        f"{API_URL}/astInhtrfEtcPtbkOpt.json",
        "주요사항보고서(자산양수도(기타), 풋백옵션) 내에 주요 정보를 제공합니다.",
    )
    BANKRUPTCY = (
        2,
        "부도발생",
        f"{API_URL}/dfOcr.json",
        "주요사항보고서(부도발생) 내에 주요 정보를 제공합니다.",
    )
    SUSPENSION = (
        3,
        "영업정지",
        f"{API_URL}/bsnSp.json",
        "주요사항보고서(영업정지) 내에 주요 정보를 제공합니다.",
    )
    RESTORATION = (
        4,
        "회생절차 개시신청",
        f"{API_URL}/ctrcvsBgrq.json",
        "주요사항보고서(회생절차 개시신청) 내에 주요 정보를 제공합니다.",
    )
    DISSOLUTION = (
        5,
        "해산사유 발생",
        f"{API_URL}/dsRsOcr.json",
        "주요사항보고서(해산사유 발생) 내에 주요 정보를 제공합니다.",
    )
    PUBLIC_ISSUANCE = (
        6,
        "유상증자 결정",
        f"{API_URL}/piicDecsn.json",
        "주요사항보고서(유상증자 결정) 내에 주요 정보를 제공합니다.",
    )
    UNPUBLIC_ISSUANCE = (
        7,
        "무상증자 결정",
        f"{API_URL}/fricDecsn.json",
        "주요사항보고서(무상증자 결정) 내에 주요 정보를 제공합니다.",
    )
    PUBLIC_UNPUBLIC_ISSUANCE = (
        8,
        "유무상증자 결정",
        f"{API_URL}/pifricDecsn.json",
        "주요사항보고서(유무상증자 결정) 내에 주요 정보를 제공합니다.",
    )
    CAPITAL_REDUCTION = (
        9,
        "감자 결정",
        f"{API_URL}/crDecsn.json",
        "주요사항보고서(감자 결정) 내에 주요 정보를 제공합니다.",
    )
    BANKRUPTCY_PROCEDURE = (
        10,
        "채권은행 등의 관리절차 개시",
        f"{API_URL}/bnkMngtPcbg.json",
        "주요사항보고서(채권은행 등의 관리절차 개시) 내에 주요 정보를 제공합니다.",
    )
    LEGAL_ACT = (
        11,
        "소송 등의 제기",
        f"{API_URL}/lwstLg.json",
        "주요사항보고서(소송 등의 제기) 내에 주요 정보를 제공합니다.",
    )
    OVERSEAS_LISTING_DECISION = (
        12,
        "해외 증권시장 주권등 상장 결정",
        f"{API_URL}/ovLstDecsn.json",
        "주요사항보고서(해외 증권시장 주권등 상장 결정) 내에 주요 정보를 제공합니다.",
    )
    OVERSEAS_DELISTING_DECISION = (
        13,
        "해외 증권시장 주권등 상장폐지 결정",
        f"{API_URL}/ovDlstDecsn.json",
        "주요사항보고서(해외 증권시장 주권등 상장폐지 결정) 내에 주요 정보를 제공합니다.",
    )
    OVERSEAS_LISTING = (
        14,
        "해외 증권시장 주권등 상장",
        f"{API_URL}/ovLst.json",
        "주요사항보고서(해외 증권시장 주권등 상장) 내에 주요 정보를 제공합니다.",
    )
    OVERSEAS_DELISTING = (
        15,
        "해외 증권시장 주권등 상장폐지",
        f"{API_URL}/ovDlst.json",
        "주요사항보고서(해외 증권시장 주권등 상장폐지) 내에 주요 정보를 제공합니다.",
    )
    CB_ISSUANCE_DECISION = (
        16,
        "전환사채권 발행결정",
        f"{API_URL}/cvbdIsDecsn.json",
        "주요사항보고서(전환사채권 발행결정) 내에 주요 정보를 제공합니다.",
    )
    BW_ISSUANCE_DECISION = (
        17,
        "신주인수권부사채권 발행결정",
        f"{API_URL}/bdwtIsDecsn.json",
        "주요사항보고서(신주인수권부사채권 발행결정) 내에 주요 정보를 제공합니다.",
    )
    EB_ISSUANCE_DECISION = (
        18,
        "교환사채권 발행결정",
        f"{API_URL}/exbdIsDecsn.json",
        "주요사항보고서(교환사채권 발행결정) 내에 주요 정보를 제공합니다.",
    )
    BANKRUPTCY_PROCEDURE_SUSPENSION = (
        19,
        "채권은행 등의 관리절차 중단",
        f"{API_URL}/bnkMngtPcsp.json",
        "주요사항보고서(채권은행 등의 관리절차 중단) 내에 주요 정보를 제공합니다.",
    )
    COCO_BOND_ISSUANCE_DECISION = (
        20,
        "상각형 조건부자본증권 발행결정",
        f"{API_URL}/wdCocobdIsDecsn.json",
        "주요사항보고서(상각형 조건부자본증권 발행결정) 내에 주요 정보를 제공합니다.",
    )
    SHARE_BUYBACK_DECISION = (
        21,
        "자기주식 취득 결정",
        f"{API_URL}/tsstkAqDecsn.json",
        "주요사항보고서(자기주식 취득 결정) 내에 주요 정보를 제공합니다.",
    )
    TREASURY_STOCK_DISPOSAL_DECISION = (
        22,
        "자기주식 처분 결정",
        f"{API_URL}/tsstkDpDecsn.json",
        "주요사항보고서(자기주식 처분 결정) 내에 주요 정보를 제공합니다.",
    )
    TRUST_AGREEMENT_ACQUISITION_DECISION = (
        23,
        "자기주식취득 신탁계약 체결 결정",
        f"{API_URL}/tsstkAqTrctrCnsDecsn.json",
        "주요사항보고서(자기주식취득 신탁계약 체결 결정) 내에 주요 정보를 제공합니다.",
    )
    TRUST_AGREEMENT_RESOLUTION_DECISION = (
        24,
        "자기주식취득 신탁계약 해지 결정",
        f"{API_URL}/tsstkAqTrctrCcDecsn.json",
        "주요사항보고서(자기주식취득 신탁계약 해지 결정) 내에 주요 정보를 제공합니다.",
    )
    BUSINESS_ACQUISITION_DECISION = (
        25,
        "영업양수 결정",
        f"{API_URL}/bsnInhDecsn.json",
        "주요사항보고서(영업양수 결정) 내에 주요 정보를 제공합니다.",
    )
    BUSINESS_TRANSFER_DECISION = (
        26,
        "영업양도 결정",
        f"{API_URL}/bsnTrfDecsn.json",
        "주요사항보고서(영업양도 결정) 내에 주요 정보를 제공합니다.",
    )
    ASSET_ACQUISITION_DECISION = (
        27,
        "유형자산 양수 결정",
        f"{API_URL}/tgastInhDecsn.json",
        "주요사항보고서(유형자산 양수 결정) 내에 주요 정보를 제공합니다.",
    )
    ASSET_TRANSFER_DECISION = (
        28,
        "유형자산 양도 결정",
        f"{API_URL}/tgastTrfDecsn.json",
        "주요사항보고서(유형자산 양도 결정) 내에 주요 정보를 제공합니다.",
    )
    OTHER_SHARE_ACQUISITION_DECISION = (
        29,
        "타법인 주식 및 출자증권 양수결정",
        f"{API_URL}/otcprStkInvscrInhDecsn.json",
        "주요사항보고서(타법인 주식 및 출자증권 양수결정) 내에 주요 정보를 제공합니다.",
    )
    OTHER_SHARE_TRANSFER_DECISION = (
        30,
        "타법인 주식 및 출자증권 양도결정",
        f"{API_URL}/otcprStkInvscrTrfDecsn.json",
        "주요사항보고서(타법인 주식 및 출자증권 양도결정) 내에 주요 정보를 제공합니다.",
    )
    EQUITY_LINKED_BOND_ACQUISITION_DECISION = (
        31,
        "주권 관련 사채권 양수 결정",
        f"{API_URL}/stkrtbdInhDecsn.json",
        "주요사항보고서(주권 관련 사채권 양수 결정) 내에 주요 정보를 제공합니다.",
    )
    EQUITY_LINKED_BOND_TRANSFER_DECISION = (
        32,
        "주권 관련 사채권 양도 결정",
        f"{API_URL}/stkrtbdTrfDecsn.json",
        "주요사항보고서(주권 관련 사채권 양도 결정) 내에 주요 정보를 제공합니다.",
    )
    COMPANY_MERGER_DECISION = (
        33,
        "회사합병 결정",
        f"{API_URL}/cmpMgDecsn.json",
        "주요사항보고서(회사합병 결정) 내에 주요 정보를 제공합니다.",
    )
    COMPANY_SPINOFF_DECISION = (
        34,
        "회사분할 결정",
        f"{API_URL}/cmpDvDecsn.json",
        "주요사항보고서(회사분할 결정) 내에 주요 정보를 제공합니다.",
    )
    COMPANY_SPINOFF_MERGER_DECISION = (
        35,
        "회사분할합병 결정",
        f"{API_URL}/cmpDvmgDecsn.json",
        "주요사항보고서(회사분할합병 결정) 내에 주요 정보를 제공합니다.",
    )
    SHARE_EXCHANGE_DECISION = (
        36,
        "주식교환·이전 결정",
        f"{API_URL}/stkExtrDecsn.json",
...
class OpenDartRequest:
    ...
    bsns_year: str | int | None = (
        None  # 사업연도	예) 사업연도(4자리) ※ 2015년 이후 부터 정보제공
    )
    bgn_de: Optional[str] = (
        None  # 시작일(최초접수일)	예) 검색시작 접수일자(YYYYMMDD) ※ 2015년 이후 부터 정보제공
    )
    end_de: Optional[str] = (
        None  # 종료일(최초접수일)	예) 검색종료 접수일자(YYYYMMDD) ※ 2015년 이후 부터 정보제공
    )

    reprt_code: ReportCode | str | None = (
        None  # 보고서 코드	예) 사업보고서 : 1분기보고서 : 11013, 반기보고서 : 11012, 3분기보고서 : 11014, 사업보고서 : 11011
    )
    fs_div: Optional[str] = (
        None  # 재무제표구분	예) 재무제표구분 : OFS(재무제표), CFS(연결재무제표)
    )
    sj_div: Optional[str] = None  # 재무제표구분	예) BS1
    idx_cl_code: Optional[IndexClassCode] = (
        None  # 지표분류코드	예) 수익성지표 : M210000, 안정성지표 : M220000, 성장성지표 : M230000, 활동성지표 : M240000
    )
    ...
    def to_params(self) -> Dict[str, Any]:
        ...
        if self.bsns_year:
            params["bsns_year"] = self.bsns_year
        if self.bgn_de:
            params["bgn_de"] = self.bgn_de
        if self.end_de:
            params["end_de"] = self.end_de
        if self.reprt_code:
            params["reprt_code"] = self.reprt_code
        if self.fs_div:
            params["fs_div"] = self.fs_div
        if self.sj_div:
            params["sj_div"] = self.sj_div
        if self.idx_cl_code:
            params["idx_cl_code"] = self.idx_cl_code
...
class DisclosureRequest:
    ...
    last_reprt_at: Optional[str] = (
        None  # 최종보고서만 검색여부(Y or N), 기본값 : N(정정이 있는 경우 최종정정만 검색)
    )
    pblntf_ty: Optional[str] = (
        None  # 공시유형	예) A:정기공시,B:주요사항보고,C:발행공시,D:지분공시,E:기타공시,F:외부감사관련,G:펀드공시,H:자산유동화,I:거래소공시,J:공정위공시
    )
    pblntf_detail_ty: Optional[str] = None  # 공시상세유형
    corp_cls: Optional[CorpClass] = (
        None  # 법인구분	예) 법인구분 : Y(유가), K(코스닥), N(코넥스), E(기타)
    )

    sort: Optional[str] = (
        None  # 정렬	예) 접수일자: date, 회사명 : crp, 보고서명 : rpt ※ 기본값 : date
    )
    sort_mth: Optional[str] = (
        None  # 정렬방법	예) 정렬방법 : 오름차순(asc), 내림차순(desc) ※ 기본값 : desc
    )
    ...
    def to_params(self) -> Dict[str, Any]:
        ...
        if self.last_reprt_at:
            params["last_reprt_at"] = self.last_reprt_at
        if self.pblntf_ty:
            params["pblntf_ty"] = self.pblntf_ty
        if self.pblntf_detail_ty:
            params["pblntf_detail_ty"] = self.pblntf_detail_ty
        if self.corp_cls:
...
class IntercorporateInvestmentData(BaseOpenDartData):
    ...
    recent_bsns_year_fnnr_sttus_tot_assets: Optional[int] = (
        None  # 최근 사업 연도 재무 현황 총 자산
    )
    recent_bsns_year_fnnr_sttus_thstrm_ntpf: Optional[int] = (
        None  # 최근 사업 연도 재무 현황 당기 순이익
    )
    stlm_dt: Optional[str] = None  # 결산기준일
...
class ProceedsUseData(BaseOpenDartData):
    ...
    rs_cptal_use_plan_useprps: Optional[str] = (
        None  # 증권신고서 등의 자금사용 계획(사용용도)
    )
    rs_cptal_use_plan_prcure_amount: Optional[int] = (
        None  # 증권신고서 등의 자금사용 계획(조달금액)
    )
...
class PrivateEquityFundsUseData(BaseOpenDartData):
    ...
    mtrpt_cptal_use_plan_useprps: Optional[str] = (
        None  # 주요사항보고서의 자금사용 계획(사용용도)
    )
    mtrpt_cptal_use_plan_prcure_amount: Optional[int] = (
        None  # 주요사항보고서의 자금사용 계획(조달금액)
    )
    real_cptal_use_dtls_cn: Optional[str] = None  # 실제 자금사용 내역(내용)
    real_cptal_use_dtls_amount: Optional[int] = None  # 실제 자금사용 내역(금액)
    dffrnc_occrrnc_resn: Optional[str] = None  # 차이발생 사유 등
...
class SingleCompanyMainAccountsData(BaseFinanceData):
    ...
    bfefrmtrm_nm: Optional[str] = (
        None  # 전전기명	예) 제 11 기말(※ 사업보고서의 경우에만 출력)
    )
    bfefrmtrm_dt: Optional[str] = (
        None  # 전전기일자	예) 2016.12.31 현재(※ 사업보고서의 경우에만 출력)
    )
    bfefrmtrm_amount: Optional[int] = (
        None  # 전전기금액	예) 9,999,999,999(※ 사업보고서의 경우에만 출력)
    )
...
class MultiCompanyMainAccountsData(BaseFinanceData):
    ...
    bfefrmtrm_nm: Optional[str] = (
        None  # 전전기명	ex) 제 11 기말(※ 사업보고서의 경우에만 출력)
    )
    bfefrmtrm_dt: Optional[str] = (
        None  # 전전기일자	ex) 2016.12.31 현재(※ 사업보고서의 경우에만 출력)
    )
    bfefrmtrm_amount: Optional[int] = (
        None  # 전전기금액	9,999,999,999(※ 사업보고서의 경우에만 출력)
    )
...
class SingleFinancialStatementData(BaseFinanceData):
    ...
    thstrm_amount: Optional[int] = (
        None  # 당기금액	예) 9,999,999,999 ※ 분/반기 보고서이면서 (포괄)손익계산서 일 경우 [3개월] 금액
    )
    thstrm_add_amount: Optional[int] = None  # 당기누적금액	예) 9,999,999,999
    frmtrm_nm: Optional[str] = None  # 전기명	예) 제 12 기말
    frmtrm_amount: Optional[int] = None  # 전기금액	예) 9,999,999,999
    ...
    frmtrm_q_amount: Optional[int] = (
        None  # 전기금액(분/반기)	예) 9,999,999,999 ※ 분/반기 보고서이면서 (포괄)손익계산서 일 경우 [3개월] 금액
    )
    frmtrm_add_amount: Optional[int] = None  # 전기누적금액	예) 9,999,999,999
    bfefrmtrm_nm: Optional[str] = (
        None  # 전전기명	예) 제 11 기말(※ 사업보고서의 경우에만 출력)
...
class SingleCompanyKeyFinancialIndicatorData(BaseFinanceData):
    ...
    idx_cl_code: Optional[str] = (
        None  # 지표분류코드	예) 수익성지표 : M210000, 안정성지표 : M220000, 성장성지표 : M230000, 활동성지표 : M240000
    )
    idx_cl_nm: Optional[str] = (
        None  # 지표분류명	예) 수익성지표,안정성지표,성장성지표,활동성지표
    )
...
class InsiderOwnershipData(BaseOwnershipData):
    ...
    isu_exctv_rgist_at: Optional[str] = (
        None  # 발행 회사 관계 임원(등기여부)	예) 등기임원, 비등기임원 등
    )
    isu_exctv_ofcps: Optional[str] = (
        None  # 발행 회사 관계 임원 직위	예) 대표이사, 이사, 전무 등
    )
    isu_main_shrholdr: Optional[str] = (
        None  # 발행 회사 관계 주요 주주	예) 10%이상주주 등
    )
    sp_stock_lmp_cnt: Optional[str] = None  # 특정 증권 등 소유 수	예) 9,999,999,999
    sp_stock_lmp_irds_cnt: Optional[str] = (
        None  # 특정 증권 등 소유 증감 수	예) 9,999,999,999
    )
    sp_stock_lmp_rate: Optional[str] = None  # 특정 증권 등 소유 비율	예) 0.00
    sp_stock_lmp_irds_rate: Optional[str] = (
        None  # 특정 증권 등 소유 증감 비율	예) 0.00
    )
...
class PublicIssuanceData(BaseOpenDartData):
    ...
    nstk_ostk_cnt: Optional[int] = (
        None  # 신주의 종류와 수(보통주식 (주))	예) 9,999,999,999
    )
    nstk_estk_cnt: Optional[int] = (
        None  # 신주의 종류와 수(기타주식 (주))	예) 9,999,999,999
    )
    fv_ps: Optional[int] = None  # 1주당 액면가액 (원)	예) 9,999,999,999
    bfic_tisstk_ostk: Optional[int] = (
        None  # 증자전 발행주식총수 (주)(보통주식 (주))	예) 9,999,999,999
    )
    bfic_tisstk_estk: Optional[int] = (
        None  # 증자전 발행주식총수 (주)(기타주식 (주))	예) 9,999,999,999
    )
    fdpp_fclt: Optional[int] = (
        None  # 자금조달의 목적(시설자금 (원))	예) 9,999,999,999
    )
    fdpp_bsninh: Optional[int] = (
        None  # 자금조달의 목적(영업양수자금 (원))	예) 9,999,999,999
    )
    fdpp_op: Optional[int] = None  # 자금조달의 목적(운영자금 (원))	예) 9,999,999,999
    fdpp_dtrp: Optional[int] = (
        None  # 자금조달의 목적(채무상환자금 (원))	예) 9,999,999,999
    )
    fdpp_ocsa: Optional[int] = (
        None  # 자금조달의 목적(타법인 증권 취득자금 (원))	예) 9,999,999,999
    )
    fdpp_etc: Optional[int] = (
        None  # 자금조달의 목적(기타자금 (원))	예) 9,999,999,999
    )
...
class UnpublicIssuanceData(BaseOpenDartData):
    ...
    nstk_ascnt_ps_ostk: Optional[int] = (
        None  # 1주당 신주배정 주식수(보통주식 (주))	예) 9,999,999,999.9x (소수점 최대 20자리)
    )
    nstk_ascnt_ps_estk: Optional[int] = (
        None  # 1주당 신주배정 주식수(기타주식 (주))	예) 9,999,999,999.9x (소수점 최대 20자리)
    )
...
class PublicUnpublicIssuanceData(BaseOpenDartData):
    ...
    piic_nstk_ostk_cnt: Optional[int] = (
        None  # 유상증자(신주의 종류와 수(보통주식 (주)))	예) 9,999,999,999
    )
    piic_nstk_estk_cnt: Optional[int] = (
        None  # 유상증자(신주의 종류와 수(기타주식 (주)))	예) 9,999,999,999
    )
    piic_fv_ps: Optional[int] = (
        None  # 유상증자(1주당 액면가액 (원))	예) 9,999,999,999
    )
    piic_bfic_tisstk_ostk: Optional[int] = (
        None  # 유상증자(증자전 발행주식총수 (주)(보통주식 (주)))	예) 9,999,999,999
    )
    piic_bfic_tisstk_estk: Optional[int] = (
        None  # 유상증자(증자전 발행주식총수 (주)(기타주식 (주)))	예) 9,999,999,999
    )
    piic_fdpp_fclt: Optional[int] = (
        None  # 유상증자(자금조달의 목적(시설자금 (원)))	예) 9,999,999,999
    )
    piic_fdpp_bsninh: Optional[int] = (
        None  # 유상증자(자금조달의 목적(영업양수자금 (원)))	예) 9,999,999,999
    )
    piic_fdpp_op: Optional[int] = (
        None  # 유상증자(자금조달의 목적(운영자금 (원)))	예) 9,999,999,999
    )
    piic_fdpp_dtrp: Optional[int] = (
        None  # 유상증자(자금조달의 목적(채무상환자금 (원)))	예) 9,999,999,999
    )
    piic_fdpp_ocsa: Optional[int] = (
        None  # 유상증자(자금조달의 목적(타법인 증권 취득자금 (원)))	예) 9,999,999,999
    )
    piic_fdpp_etc: Optional[int] = (
        None  # 유상증자(자금조달의 목적(기타자금 (원)))	예) 9,999,999,999
    )
    piic_ic_mthn: Optional[str] = None  # 유상증자(증자방식)	유상증자(증자방식)
    fric_nstk_ostk_cnt: Optional[int] = (
        None  # 무상증자(신주의 종류와 수(보통주식 (주)))	예) 9,999,999,999
    )
    fric_nstk_estk_cnt: Optional[int] = (
        None  # 무상증자(신주의 종류와 수(기타주식 (주)))	예) 9,999,999,999
    )
    fric_fv_ps: Optional[int] = (
        None  # 무상증자(1주당 액면가액 (원))	예) 9,999,999,999
    )
    fric_bfic_tisstk_ostk: Optional[int] = (
        None  # 무상증자(증자전 발행주식총수(보통주식 (주)))	예) 9,999,999,999
    )
    fric_bfic_tisstk_estk: Optional[int] = (
        None  # 무상증자(증자전 발행주식총수(기타주식 (주)))	예) 9,999,999,999
    )
    fric_nstk_asstd: Optional[str] = None  # 무상증자(신주배정기준일)
    fric_nstk_ascnt_ps_ostk: Optional[int] = (
        None  # 무상증자(1주당 신주배정 주식수(보통주식 (주)))	예) 9,999,999,999.9x (소수점 최대 20자리)
    )
    fric_nstk_ascnt_ps_estk: Optional[int] = (
        None  # 무상증자(1주당 신주배정 주식수(기타주식 (주)))	예) 9,999,999,999.9x (소수점 최대 20자리)
    )
    ...
    fric_od_a_at_t: Optional[int] = (
        None  # 무상증자(사외이사 참석여부(참석(명)))	예) 9,999,999,999
    )
    fric_od_a_at_b: Optional[int] = (
        None  # 무상증자(사외이사 참석여부(불참(명)))	예) 9,999,999,999
    )
...
class CapitalReductionData(BaseOpenDartData):
    ...
    crstk_ostk_cnt: Optional[int] = (
        None  # 감자주식의 종류와 수(보통주식 (주))	예) 9,999,999,999
    )
    crstk_estk_cnt: Optional[int] = (
        None  # 감자주식의 종류와 수(기타주식 (주))	예) 9,999,999,999
    )
    fv_ps: Optional[int] = None  # 1주당 액면가액 (원)	예) 9,999,999,999
    bfcr_cpt: Optional[int] = None  # 감자전후 자본금(감자전 (원))	예) 9,999,999,999
    atcr_cpt: Optional[int] = None  # 감자전후 자본금(감자후 (원))	예) 9,999,999,999
    bfcr_tisstk_ostk: Optional[int] = (
        None  # 감자전후 발행주식수(보통주식 (주)(감자전 (원)))	예) 9,999,999,999
    )
    atcr_tisstk_ostk: Optional[int] = (
        None  # 감자전후 발행주식수(보통주식 (주)(감자후 (원)))	예) 9,999,999,999
    )
    bfcr_tisstk_estk: Optional[int] = (
        None  # 감자전후 발행주식수(기타주식 (주)(감자전 (원)))	예) 9,999,999,999
    )
    atcr_tisstk_estk: Optional[int] = (
        None  # 감자전후 발행주식수(기타주식 (주)(감자후 (원)))	예) 9,999,999,999
    )
...
class OverseasListingDecisionData(BaseOpenDartData):
    ...
    lstprstk_ostk_cnt: Optional[int] = (
        None  # 상장예정주식 종류ㆍ수(주)(보통주식)	예) 9,999,999,999
    )
    lstprstk_estk_cnt: Optional[int] = (
        None  # 상장예정주식 종류ㆍ수(주)(기타주식)	예) 9,999,999,999
    )
    tisstk_ostk: Optional[int] = (
        None  # 발행주식 총수(주)(보통주식)	예) 9,999,999,999
    )
    tisstk_estk: Optional[int] = (
        None  # 발행주식 총수(주)(기타주식)	예) 9,999,999,999
    )
...
class OverseasDelistingDecisionData(BaseOpenDartData):
    ...
    dlststk_ostk_cnt: Optional[int] = (
        None  # 상장폐지주식 종류ㆍ수(주)(보통주식)	예) 9,999,999,999
    )
    dlststk_estk_cnt: Optional[int] = (
        None  # 상장폐지주식 종류ㆍ수(주)(기타주식)	예) 9,999,999,999
    )
...
class OverseasListingData(BaseOpenDartData):
    ...
    lststk_ostk_cnt: Optional[int] = (
        None  # 상장주식 종류 및 수(보통주식(주))	예) 9,999,999,999
    )
    lststk_estk_cnt: Optional[int] = (
        None  # 상장주식 종류 및 수(기타주식(주))	예) 9,999,999,999
    )
    lstex_nt: Optional[str] = None  # 상장거래소(소재국가)	상장거래소(소재국가)
...
class OverseasDelistingData(BaseOpenDartData):
    ...
    dlststk_ostk_cnt: Optional[int] = (
        None  # 상장폐지주식의 종류(보통주식(주))	예) 9,999,999,999
    )
    dlststk_estk_cnt: Optional[int] = (
        None  # 상장폐지주식의 종류(기타주식(주))	예) 9,999,999,999
    )
...
class CBIssuanceDecisionData(BaseOpenDartData):
    ...
    atcsc_rmislmt: Optional[int] = (
        None  # 정관상 잔여 발행한도 (원)	예) 9,999,999,999
    )
    ...
    cv_prc: Optional[int] = (
        None  # 전환에 관한 사항(전환가액 (원/주))	예) 9,999,999,999
    )
    cvisstk_knd: Optional[str] = None  # 전환에 관한 사항(전환에 따라 발행할 주식(종류))
    cvisstk_cnt: Optional[int] = (
        None  # 전환에 관한 사항(전환에 따라 발행할 주식(주식수))	예) 9,999,999,999
    )
    cvisstk_tisstk_vs: Optional[float] = (
        None  # 전환에 관한 사항(전환에 따라 발행할 주식(주식총수 대비 비율(%)))
    )
    ...
    act_mktprcfl_cvprc_lwtrsprc: Optional[int] = (
        None  # 전환에 관한 사항(시가하락에 따른 전환가액 조정(최저 조정가액 (원)))	예) 9,999,999,999
    )
    act_mktprcfl_cvprc_lwtrsprc_bs: Optional[str] = (
        None  # 전환에 관한 사항(시가하락에 따른 전환가액 조정(최저 조정가액 근거))
    )
    rmislmt_lt70p: Optional[int] = (
        None  # 전환에 관한 사항(시가하락에 따른 전환가액 조정(발행당시 전환가액의 70% 미만으로 조정가능한 잔여 발행한도 (원)))	예) 9,999,999,999
    )
    ...
    od_a_at_t: Optional[int] = None  # 사외이사 참석여부(참석 (명))	예) 9,999,999,999
    od_a_at_b: Optional[int] = None  # 사외이사 참석여부(불참 (명))	예) 9,999,999,999
    adt_a_atn: Optional[str] = (
        None  # 감사(감사위원) 참석여부	감사(감사위원) 참석여부
    )
    rs_sm_atn: Optional[str] = (
        None  # 증권신고서 제출대상 여부	증권신고서 제출대상 여부
    )
    ex_sm_r: Optional[str] = (
        None  # 제출을 면제받은 경우 그 사유	제출을 면제받은 경우 그 사유
    )
    ovis_ltdtl: Optional[str] = (
        None  # 당해 사채의 해외발행과 연계된 대차거래 내역	당해 사채의 해외발행과 연계된 대차거래 내역
    )
    ftc_stt_atn: Optional[str] = None  # 공정거래위원회 신고대상 여부
...
class BWIssuanceDecisionData(BaseOpenDartData):
    ...
    ex_prc: Optional[int] = (
        None  # 신주인수권에 관한 사항(행사가액 (원/주))	예) 9,999,999,999
    )
    ex_prc_dmth: Optional[str] = None  # 신주인수권에 관한 사항(행사가액 결정방법)
    bdwt_div_atn: Optional[str] = (
        None  # 신주인수권에 관한 사항(사채와 인수권의 분리여부)
    )
    nstk_pym_mth: Optional[str] = None  # 신주인수권에 관한 사항(신주대금 납입방법)
    nstk_isstk_knd: Optional[str] = (
        None  # 신주인수권에 관한 사항(신주인수권 행사에 따라 발행할 주식(종류))
    )
    nstk_isstk_cnt: Optional[int] = (
        None  # 신주인수권에 관한 사항(신주인수권 행사에 따라 발행할 주식(주식수))	예) 9,999,999,999
    )
    nstk_isstk_tisstk_vs: Optional[float] = (
        None  # 신주인수권에 관한 사항(신주인수권 행사에 따라 발행할 주식(주식총수 대비 비율(%)))
    )
    expd_bgd: Optional[str] = None  # 신주인수권에 관한 사항(권리행사기간(시작일))
    expd_edd: Optional[str] = None  # 신주인수권에 관한 사항(권리행사기간(종료일))
    act_mktprcfl_cvprc_lwtrsprc: Optional[int] = (
        None  # 신주인수권에 관한 사항(시가하락에 따른 행사가액 조정(최저 조정가액 (원)))	예) 9,999,999,999
    )
    act_mktprcfl_cvprc_lwtrsprc_bs: Optional[str] = (
        None  # 신주인수권에 관한 사항(시가하락에 따른 행사가액 조정(최저 조정가액 근거))
    )
    rmislmt_lt70p: Optional[int] = (
        None  # 신주인수권에 관한 사항(시가하락에 따른 행사가액 조정(발행당시 행사가액의 70% 미만으로 조정가능한 잔여 발행한도 (원)))	예) 9,999,999,999
    )
    abmg: Optional[str] = None  # 합병 관련 사항
...
class EBIssuanceDecisionData(BaseOpenDartData):
    ...
    ex_prc: Optional[int] = (
        None  # 교환에 관한 사항(교환가액 (원/주))	예) 9,999,999,999
    )
    ex_prc_dmth: Optional[str] = None  # 교환에 관한 사항(교환가액 결정방법)
    extg: Optional[str] = None  # 교환에 관한 사항(교환대상(종류))
    extg_stkcnt: Optional[int] = (
        None  # 교환에 관한 사항(교환대상(주식수))	예) 9,999,999,999
    )
    extg_tisstk_vs: Optional[float] = (
        None  # 교환에 관한 사항(교환대상(주식총수 대비 비율(%)))
    )
...
class ShareBuybackDecisionData(BaseOpenDartData):
    ...
    aq_wtn_div_ostk: Optional[int] = (
        None  # 취득 전 자기주식 보유현황(배당가능이익 범위 내 취득(주)(보통주식))	9,999,999,999
    )
    aq_wtn_div_ostk_rt: Optional[float] = (
        None  # 취득 전 자기주식 보유현황(배당가능이익 범위 내 취득(주)(비율(%)))
    )
    aq_wtn_div_estk: Optional[int] = (
        None  # 취득 전 자기주식 보유현황(배당가능이익 범위 내 취득(주)(기타주식))	9,999,999,999
    )
    aq_wtn_div_estk_rt: Optional[float] = (
        None  # 취득 전 자기주식 보유현황(배당가능이익 범위 내 취득(주)(비율(%)))
    )
    eaq_ostk: Optional[int] = (
        None  # 취득 전 자기주식 보유현황(기타취득(주)(보통주식))	9,999,999,999
    )
    eaq_ostk_rt: Optional[float] = (
        None  # 취득 전 자기주식 보유현황(기타취득(주)(비율(%)))
    )
    eaq_estk: Optional[int] = (
        None  # 취득 전 자기주식 보유현황(기타취득(주)(기타주식))	9,999,999,999
    )
    eaq_estk_rt: Optional[float] = (
        None  # 취득 전 자기주식 보유현황(기타취득(주)(비율(%)))
    )
    ...
    d1_prodlm_ostk: Optional[int] = (
        None  # 1일 매수 주문수량 한도(보통주식)	9,999,999,999
    )
    d1_prodlm_estk: Optional[int] = (
        None  # 1일 매수 주문수량 한도(기타주식)	9,999,999,999
    )
...
class TreasuryStockDisposalDecisionData(BaseOpenDartData):
    ...
    dpstk_prc_ostk: Optional[int] = (
        None  # 처분 대상 주식가격(원)(보통주식)	9,999,999,999
    )
    dpstk_prc_estk: Optional[int] = (
        None  # 처분 대상 주식가격(원)(기타주식)	9,999,999,999
    )
    ...
    cs_iv_bk: Optional[str] = None  # 위탁투자중개업자
    aq_wtn_div_ostk: Optional[int] = (
        None  # 처분 전 자기주식 보유현황(배당가능이익 범위 내 취득(주)(보통주식))	9,999,999,999
    )
    aq_wtn_div_ostk_rt: Optional[float] = (
        None  # 처분 전 자기주식 보유현황(배당가능이익 범위 내 취득(주)(비율(%)))
    )
    aq_wtn_div_estk: Optional[int] = (
        None  # 처분 전 자기주식 보유현황(배당가능이익 범위 내 취득(주)(기타주식))	9,999,999,999
    )
    aq_wtn_div_estk_rt: Optional[float] = (
        None  # 처분 전 자기주식 보유현황(배당가능이익 범위 내 취득(주)(비율(%)))
    )
    eaq_ostk: Optional[int] = (
        None  # 처분 전 자기주식 보유현황(기타취득(주)(보통주식))	9,999,999,999
    )
    eaq_ostk_rt: Optional[float] = (
        None  # 처분 전 자기주식 보유현황(기타취득(주)(비율(%)))
    )
    eaq_estk: Optional[int] = (
        None  # 처분 전 자기주식 보유현황(기타취득(주)(기타주식))	9,999,999,999
    )
    eaq_estk_rt: Optional[float] = (
        None  # 처분 전 자기주식 보유현황(기타취득(주)(비율(%)))
    )
    ...
    od_a_at_b: Optional[int] = None  # 사외이사참석여부(불참(명))	9,999,999,999
    adt_a_atn: Optional[str] = None  # 감사(사외이사가 아닌 감사위원)참석여부
    d1_slodlm_ostk: Optional[int] = (
        None  # 1일 매도 주문수량 한도(보통주식)	9,999,999,999
    )
    d1_slodlm_estk: Optional[int] = (
        None  # 1일 매도 주문수량 한도(기타주식)	9,999,999,999
    )
...
class TrustAgreementAcquisitionDecisionData(BaseOpenDartData):
    ...
    aq_wtn_div_ostk: Optional[int] = (
        None  # 계약 전 자기주식 보유현황(배당가능범위 내 취득(주)(보통주식))	9,999,999,999
    )
    aq_wtn_div_ostk_rt: Optional[float] = (
        None  # 계약 전 자기주식 보유현황(배당가능범위 내 취득(주)(비율(%)))
    )
    aq_wtn_div_estk: Optional[int] = (
        None  # 계약 전 자기주식 보유현황(배당가능범위 내 취득(주)(기타주식))	9,999,999,999
    )
    aq_wtn_div_estk_rt: Optional[float] = (
        None  # 계약 전 자기주식 보유현황(배당가능범위 내 취득(주)(비율(%)))
    )
    eaq_ostk: Optional[int] = (
        None  # 계약 전 자기주식 보유현황(기타취득(주)(보통주식))	9,999,999,999
    )
    eaq_ostk_rt: Optional[float] = (
        None  # 계약 전 자기주식 보유현황(기타취득(주)(비율(%)))
    )
    eaq_estk: Optional[int] = (
        None  # 계약 전 자기주식 보유현황(기타취득(주)(기타주식))	9,999,999,999
    )
    eaq_estk_rt: Optional[float] = (
        None  # 계약 전 자기주식 보유현황(기타취득(주)(비율(%)))
    )
...
class TrustAgreementResolutionDecisionData(BaseOpenDartData):
    ...
    aq_wtn_div_ostk: Optional[int] = (
        None  # 해지 전 자기주식 보유현황(배당가능범위 내 취득(주)(보통주식))	9,999,999,999
    )
    aq_wtn_div_ostk_rt: Optional[float] = (
        None  # 해지 전 자기주식 보유현황(배당가능범위 내 취득(주)(비율(%)))
    )
    aq_wtn_div_estk: Optional[int] = (
        None  # 해지 전 자기주식 보유현황(배당가능범위 내 취득(주)(기타주식))	9,999,999,999
    )
    aq_wtn_div_estk_rt: Optional[float] = (
        None  # 해지 전 자기주식 보유현황(배당가능범위 내 취득(주)(비율(%)))
    )
    eaq_ostk: Optional[int] = (
        None  # 해지 전 자기주식 보유현황(기타취득(주)(보통주식))	9,999,999,999
    )
    eaq_ostk_rt: Optional[float] = (
        None  # 해지 전 자기주식 보유현황(기타취득(주)(비율(%)))
    )
    eaq_estk: Optional[int] = (
        None  # 해지 전 자기주식 보유현황(기타취득(주)(기타주식))	9,999,999,999
    )
    eaq_estk_rt: Optional[float] = (
        None  # 해지 전 자기주식 보유현황(기타취득(주)(비율(%)))
    )
...
class BusinessAcquisitionDecisionData(BaseOpenDartData):
    ...
    ast_inh_bsn: Optional[int] = (
        None  # 재무내용(원)(자산액(양수대상 영업부문(A)))	9,999,999,999
    )
    ast_cmp_all: Optional[int] = (
        None  # 재무내용(원)(자산액(당사전체(B)))	9,999,999,999
    )
    ast_rt: Optional[float] = None  # 재무내용(원)(자산액(비중(%)(A/B))
    sl_inh_bsn: Optional[int] = (
        None  # 재무내용(원)(매출액(양수대상 영업부문(A)))	9,999,999,999
    )
    sl_cmp_all: Optional[int] = (
        None  # 재무내용(원)(매출액(당사전체(B)))	9,999,999,999
    )
    sl_rt: Optional[float] = None  # 재무내용(원)(매출액(비중(%)(A/B)))
    dbt_inh_bsn: Optional[int] = (
        None  # 재무내용(원)(부채액(양수대상 영업부문(A)))	9,999,999,999
    )
    dbt_cmp_all: Optional[int] = (
        None  # 재무내용(원)(부채액(당사전체(B)))	9,999,999,999
    )
    ...
    aprskh_plnprc: Optional[int] = (
        None  # 주식매수청구권에 관한 사항(매수예정가격)	9,999,999,999
    )
    aprskh_pym_plpd_mth: Optional[str] = (
        None  # 주식매수청구권에 관한 사항(지급예정시기, 지급방법)
    )
    aprskh_lmt: Optional[str] = (
        None  # 주식매수청구권에 관한 사항(주식매수청구권 제한 관련 내용)
    )
...
class BusinessTransferDecisionData(BaseOpenDartData):
    ...
    ast_trf_bsn: Optional[int] = (
        None  # 재무내용(원)(자산액(양도대상 영업부문(A))) 예) 9,999,999,999
    )
    ast_cmp_all: Optional[int] = (
        None  # 재무내용(원)(자산액(당사전체(B)))) 예) 9,999,999,999
    )
    ast_rt: Optional[float] = None  # 재무내용(원)(자산액(비중(%)(A/B)))
    sl_trf_bsn: Optional[int] = (
        None  # 재무내용(원)(매출액(양도대상 영업부문(A)))) 예) 9,999,999,999
    )
    sl_cmp_all: Optional[int] = (
        None  # 재무내용(원)(매출액(당사전체(B)))) 예) 9,999,999,999
    )
    sl_rt: Optional[float] = None  # 재무내용(원)(매출액(비중(%)(A/B)))
    ...
    gmtsck_prd: Optional[str] = None  # 주주총회 예정일자
    aprskh_plnprc: Optional[int] = (
        None  # 주식매수청구권에 관한 사항(매수예정가격) 예) 9,999,999,999
    )
    aprskh_pym_plpd_mth: Optional[str] = (
        None  # 주식매수청구권에 관한 사항(지급예정시기, 지급방법)
    )
...
class AssetTransferDecisionData(BaseOpenDartData):
    ...
    aprskh_ex_pc_mth_pd_pl: Optional[str] = (
        None  # 주식매수청구권에 관한 사항(행사절차, 방법, 기간, 장소)
    )
    aprskh_pym_plpd_mth: Optional[str] = (
        None  # 주식매수청구권에 관한 사항(지급예정시기, 지급방법)
    )
...
class OtherShareTransferDecisionData(BaseOpenDartData):
    ...
    l6m_tpa_nstkaq_atn: Optional[str] = (
        None  # 최근 6월 이내 제3자 배정에 의한 신주취득 여부
    )
    ...
    atinh_owstkcnt: Optional[int] = (
        None  # 양수후 소유주식수 및 지분비율(소유주식수(주)) 예) 9,999,999,999
    )
    ...
    attrf_owstkcnt: Optional[int] = (
        None  # 양도후 소유주식수 및 지분비율(소유주식수(주)) 예) 9,999,999,999
    )
    ...
    bdlst_atn: Optional[str] = None  # 우회상장 해당 여부
    n6m_tpai_plann: Optional[str] = None  # 향후 6월이내 제3자배정 증자 등 계획
    iscmp_bdlst_sf_atn: Optional[str] = (
        None  # 발행회사(타법인)의 우회상장 요건 충족여부
    )
    ftc_stt_atn: Optional[str] = None  # 공정거래위원회 신고대상 여부
    popt_ctr_atn: Optional[str] = None  # 풋옵션 등 계약 체결여부
    popt_ctr_cn: Optional[str] = None  # 계약내용
...
class EquityLinkedBondsTransferDecisionData(BaseOpenDartData):
    ...
    bdiscmp_tisstk: Optional[int] = (
        None  # 사채권 발행회사(발행주식 총수(주)) 예) 9,999,999,999
    )
    ...
    inhdtl_bd_fta: Optional[int] = (
        None  # 양수내역(사채의 권면(전자등록)총액(원)) 예) 9,999,999,999
    )
    inhdtl_inhprc: Optional[int] = None  # 양수내역(양수금액(원)(A)) 예) 9,999,999,999
    inhdtl_tast: Optional[int] = None  # 양수내역(총자산(원)(B)) 예) 9,999,999,999
    inhdtl_tast_vs: Optional[float] = None  # 양수내역(총자산대비(%)(A/B))
    ...
    trfdtl_bd_fta: Optional[int] = (
        None  # 양도내역(사채의 권면(전자등록)총액(원)) 예) 9,999,999,999
    )
    trfdtl_trfprc: Optional[int] = None  # 양도내역(양도금액(원)(A)) 예) 9,999,999,999
    trfdtl_tast: Optional[int] = None  # 양도내역(총자산(원)(B)) 예) 9,999,999,999
    trfdtl_tast_vs: Optional[float] = None  # 양도내역(총자산대비(%)(A/B))
...
class CompanyMergerDecisionData(BaseOpenDartData):
    ...
    exevl_pd: Optional[str] = None  # 외부평가에 관한 사항(외부평가 기간)
    exevl_op: Optional[str] = None  # 외부평가에 관한 사항(외부평가 의견)
    mgnstk_ostk_cnt: Optional[int] = (
        None  # 합병신주의 종류와 수(주)(보통주식) 예) 9,999,999,999
    )
    mgnstk_cstk_cnt: Optional[int] = (
        None  # 합병신주의 종류와 수(주)(종류주식) 예) 9,999,999,999
    )
    ...
    rbsnfdtl_tast: Optional[int] = (
        None  # 합병상대회사(최근 사업연도 재무내용(원)(자산총계)) 예) 9,999,999,999
    )
    rbsnfdtl_tdbt: Optional[int] = (
        None  # 합병상대회사(최근 사업연도 재무내용(원)(부채총계)) 예) 9,999,999,999
    )
    rbsnfdtl_teqt: Optional[int] = (
        None  # 합병상대회사(최근 사업연도 재무내용(원)(자본총계)) 예) 9,999,999,999
    )
    rbsnfdtl_cpt: Optional[int] = (
        None  # 합병상대회사(최근 사업연도 재무내용(원)(자본금)) 예) 9,999,999,999
    )
    rbsnfdtl_sl: Optional[int] = (
        None  # 합병상대회사(최근 사업연도 재무내용(원)(매출액)) 예) 9,999,999,999
    )
    rbsnfdtl_nic: Optional[int] = (
        None  # 합병상대회사(최근 사업연도 재무내용(원)(당기순이익)) 예) 9,999,999,999
    )
    ...
    ffdtl_tast: Optional[int] = (
        None  # 신설합병회사(설립시 재무내용(원)(자산총계)) 예) 9,999,999,999
    )
    ffdtl_tdbt: Optional[int] = (
        None  # 신설합병회사(설립시 재무내용(원)(부채총계)) 예) 9,999,999,999
    )
    ffdtl_teqt: Optional[int] = (
        None  # 신설합병회사(설립시 재무내용(원)(자본총계)) 예) 9,999,999,999
    )
    ffdtl_cpt: Optional[int] = (
        None  # 신설합병회사(설립시 재무내용(원)(자본금)) 예) 9,999,999,999
    )
    ffdtl_std: Optional[int] = None  # 신설합병회사(설립시 재무내용(원)(현재기준))
    nmgcmp_nbsn_rsl: Optional[int] = (
        None  # 신설합병회사(신설사업부문 최근 사업연도 매출액(원)) 예) 9,999,999,999
    )
    ...
    mgsc_mgop_rcpd_bgd: Optional[str] = (
        None  # 합병일정(합병반대의사통지 접수기간(시작일))
    )
    mgsc_mgop_rcpd_edd: Optional[str] = (
        None  # 합병일정(합병반대의사통지 접수기간(종료일))
    )
    mgsc_gmtsck_prd: Optional[str] = None  # 합병일정(주주총회예정일자)
    mgsc_aprskh_expd_bgd: Optional[str] = (
        None  # 합병일정(주식매수청구권 행사기간(시작일))
    )
    mgsc_aprskh_expd_edd: Optional[str] = (
        None  # 합병일정(주식매수청구권 행사기간(종료일))
    )
...
class CompanySpinoffDecisionData(BaseOpenDartData):
    ...
    atdvfdtl_tast: Optional[int] = (
        None  # 분할 후 존속회사(분할후 재무내용(원)(자산총계)) 예) 9,999,999,999
    )
    atdvfdtl_tdbt: Optional[int] = (
        None  # 분할 후 존속회사(분할후 재무내용(원)(부채총계)) 예) 9,999,999,999
    )
    atdvfdtl_teqt: Optional[int] = (
        None  # 분할 후 존속회사(분할후 재무내용(원)(자본총계)) 예) 9,999,999,999
    )
    atdvfdtl_cpt: Optional[int] = (
        None  # 분할 후 존속회사(분할후 재무내용(원)(자본금)) 예) 9,999,999,999
    )
    atdvfdtl_std: Optional[str] = (
        None  # 분할 후 존속회사(분할후 재무내용(원)(현재기준))
    )
    atdv_excmp_exbsn_rsl: Optional[int] = (
        None  # 분할 후 존속회사(존속사업부문 최근 사업연도매출액(원)) 예) 9,999,999,999
    )
    atdv_excmp_mbsn: Optional[str] = None  # 분할 후 존속회사(주요사업)
    atdv_excmp_atdv_lstmn_atn: Optional[str] = (
        None  # 분할 후 존속회사(분할 후 상장유지 여부)
    )
    dvfcmp_cmpnm: Optional[str] = None  # 분할설립회사(회사명)
    ffdtl_tast: Optional[int] = (
        None  # 분할설립회사(설립시 재무내용(원)(자산총계)) 예) 9,999,999,999
    )
    ffdtl_tdbt: Optional[int] = (
        None  # 분할설립회사(설립시 재무내용(원)(부채총계)) 예) 9,999,999,999
    )
    ffdtl_teqt: Optional[int] = (
        None  # 분할설립회사(설립시 재무내용(원)(자본총계)) 예) 9,999,999,999
    )
    ffdtl_cpt: Optional[int] = (
        None  # 분할설립회사(설립시 재무내용(원)(자본금)) 예) 9,999,999,999
    )
    ffdtl_std: Optional[str] = None  # 분할설립회사(설립시 재무내용(원)(현재기준))
    dvfcmp_nbsn_rsl: Optional[int] = (
        None  # 분할설립회사(신설사업부문 최근 사업연도 매출액(원)) 예) 9,999,999,999
    )
    ...
    abcr_trspprpd_bgd: Optional[str] = (
        None  # 감자에 관한 사항(매매거래정지 예정기간(시작일))
    )
    abcr_trspprpd_edd: Optional[str] = (
        None  # 감자에 관한 사항(매매거래정지 예정기간(종료일))
    )
    abcr_nstkascnd: Optional[str] = None  # 감자에 관한 사항(신주배정조건)
    abcr_shstkcnt_rt_at_rs: Optional[str] = (
        None  # 감자에 관한 사항(주주 주식수 비례여부 및 사유)
    )
...
class CompanySpinoffMergerDecisionData(BaseOpenDartData):
    ...
    dv_trfbsnprt_cn: Optional[str] = (
        None  # 분할에 관한 사항(분할로 이전할 사업 및 재산의 내용)
    )
    atdv_excmp_cmpnm: Optional[str] = None  # 분할에 관한 사항(분할 후 존속회사(회사명))
    atdvfdtl_tast: Optional[int] = (
        None  # 분할에 관한 사항(분할 후 존속회사(분할후 재무내용(원)(자산총계))) 예) 9,999,999,999
    )
    atdvfdtl_tdbt: Optional[int] = (
        None  # 분할에 관한 사항(분할 후 존속회사(분할후 재무내용(원)(부채총계))) 예) 9,999,999,999
    )
    atdvfdtl_teqt: Optional[int] = (
        None  # 분할에 관한 사항(분할 후 존속회사(분할후 재무내용(원)(자본총계))) 예) 9,999,999,999
    )
    atdvfdtl_cpt: Optional[int] = (
        None  # 분할에 관한 사항(분할 후 존속회사(분할후 재무내용(원)(자본금))) 예) 9,999,999,999
    )
    atdvfdtl_std: Optional[str] = (
        None  # 분할에 관한 사항(분할 후 존속회사(분할후 재무내용(원)(현재기준)))
    )
    atdv_excmp_exbsn_rsl: Optional[int] = (
        None  # 분할에 관한 사항(분할 후 존속회사(존속사업부문 최근 사업연도매출액(원))) 예) 9,999,999,999
    )
    atdv_excmp_mbsn: Optional[str] = (
        None  # 분할에 관한 사항(분할 후 존속회사(주요사업))
    )
    atdv_excmp_atdv_lstmn_atn: Optional[str] = (
        None  # 분할에 관한 사항(분할 후 존속회사(분할 후 상장유지 여부))
    )
    dvfcmp_cmpnm: Optional[str] = None  # 분할에 관한 사항(분할설립 회사(회사명))
    ffdtl_tast: Optional[int] = (
        None  # 분할에 관한 사항(분할설립 회사(설립시 재무내용(원)(자산총계))) 예) 9,999,999,999
    )
    ffdtl_tdbt: Optional[int] = (
        None  # 분할에 관한 사항(분할설립 회사(설립시 재무내용(원)(부채총계))) 예) 9,999,999,999
    )
    ffdtl_teqt: Optional[int] = (
        None  # 분할에 관한 사항(분할설립 회사(설립시 재무내용(원)(자본총계))) 예) 9,999,999,999
    )
    ffdtl_cpt: Optional[int] = (
        None  # 분할에 관한 사항(분할설립 회사(설립시 재무내용(원)(자본금))) 예) 9,999,999,999
    )
    ffdtl_std: Optional[str] = (
        None  # 분할에 관한 사항(분할설립 회사(설립시 재무내용(원)(현재기준)))
    )
    dvfcmp_nbsn_rsl: Optional[int] = (
        None  # 분할에 관한 사항(분할설립 회사(신설사업부문 최근 사업연도 매출액(원))) 예) 9,999,999,999
    )
    dvfcmp_mbsn: Optional[str] = None  # 분할에 관한 사항(분할설립 회사(주요사업))
    dvfcmp_atdv_lstmn_at: Optional[str] = (
        None  # 분할에 관한 사항(분할설립 회사(분할후 상장유지여부))
    )
    abcr_crrt: Optional[float] = None  # 분할에 관한 사항(감자에 관한 사항(감자비율(%)))
    abcr_osprpd_bgd: Optional[str] = (
        None  # 분할에 관한 사항(감자에 관한 사항(구주권 제출기간(시작일)))
    )
    abcr_osprpd_edd: Optional[str] = (
        None  # 분할에 관한 사항(감자에 관한 사항(구주권 제출기간(종료일)))
    )
    abcr_trspprpd_bgd: Optional[str] = (
        None  # 분할에 관한 사항(감자에 관한 사항(매매거래정지 예정기간(시작일)))
    )
    abcr_trspprpd_edd: Optional[str] = (
        None  # 분할에 관한 사항(감자에 관한 사항(매매거래정지 예정기간(종료일)))
    )
    abcr_nstkascnd: Optional[str] = (
        None  # 분할에 관한 사항(감자에 관한 사항(신주배정조건))
    )
    abcr_shstkcnt_rt_at_rs: Optional[str] = (
        None  # 분할에 관한 사항(감자에 관한 사항(주주 주식수 비례여부 및 사유))
    )
    abcr_nstkasstd: Optional[str] = (
        None  # 분할에 관한 사항(감자에 관한 사항(신주배정기준일))
    )
    abcr_nstkdlprd: Optional[str] = (
        None  # 분할에 관한 사항(감자에 관한 사항(신주권교부예정일))
    )
    abcr_nstklstprd: Optional[str] = (
        None  # 분할에 관한 사항(감자에 관한 사항(신주의 상장예정일))
    )
    ...
    mgptncmp_rl_cmpn: Optional[str] = (
        None  # 합병에 관한 사항(합병상대 회사(회사와의 관계))
    )
    rbsnfdtl_tast: Optional[int] = (
        None  # 합병에 관한 사항(합병상대 회사(최근 사업연도 재무내용(원)(자산총계))) 예) 9,999,999,999
    )
    rbsnfdtl_tdbt: Optional[int] = (
        None  # 합병에 관한 사항(합병상대 회사(최근 사업연도 재무내용(원)(부채총계))) 예) 9,999,999,999
    )
    rbsnfdtl_teqt: Optional[int] = (
        None  # 합병에 관한 사항(합병상대 회사(최근 사업연도 재무내용(원)(자본총계))) 예) 9,999,999,999
    )
    rbsnfdtl_cpt: Optional[int] = (
        None  # 합병에 관한 사항(합병상대 회사(최근 사업연도 재무내용(원)(자본금))) 예) 9,999,999,999
    )
    rbsnfdtl_sl: Optional[int] = (
        None  # 합병에 관한 사항(합병상대 회사(최근 사업연도 재무내용(원)(매출액))) 예) 9,999,999,999
    )
    rbsnfdtl_nic: Optional[int] = (
        None  # 합병에 관한 사항(합병상대 회사(최근 사업연도 재무내용(원)(당기순이익))) 예) 9,999,999,999
    )
    eadtat_intn: Optional[str] = (
        None  # 합병에 관한 사항(합병상대 회사(외부감사 여부(기관명)))
    )
    eadtat_op: Optional[str] = (
        None  # 합병에 관한 사항(합병상대 회사(외부감사 여부(감사의견)))
    )
    dvmgnstk_ostk_cnt: Optional[int] = (
        None  # 합병에 관한 사항(분할합병신주의 종류와 수(주)(보통주식)) 예) 9,999,999,999
    )
    dvmgnstk_cstk_cnt: Optional[int] = (
        None  # 합병에 관한 사항(분할합병신주의 종류와 수(주)(종류주식)) 예) 9,999,999,999
    )
    nmgcmp_cmpnm: Optional[str] = None  # 합병에 관한 사항(합병신설 회사(회사명))
    nmgcmp_cpt: Optional[int] = (
        None  # 합병에 관한 사항(합병신설 회사(자본금(원))) 예) 9,999,999,999
    )
    nmgcmp_mbsn: Optional[str] = None  # 합병에 관한 사항(합병신설 회사(주요사업))
    nmgcmp_rlst_atn: Optional[str] = (
        None  # 합병에 관한 사항(합병신설 회사(재상장신청 여부))
    )
    ...
    dvmgsc_dvmgop_rcpd_bgd: Optional[str] = (
        None  # 분할합병일정(분할합병반대의사통지 접수기간(시작일))
    )
    dvmgsc_dvmgop_rcpd_edd: Optional[str] = (
        None  # 분할합병일정(분할합병반대의사통지 접수기간(종료일))
    )
    dvmgsc_gmtsck_prd: Optional[str] = None  # 분할합병일정(주주총회예정일자)
    dvmgsc_aprskh_expd_bgd: Optional[str] = (
        None  # 분할합병일정(주식매수청구권 행사기간(시작일))
    )
    dvmgsc_aprskh_expd_edd: Optional[str] = (
        None  # 분할합병일정(주식매수청구권 행사기간(종료일))
    )
    dvmgsc_cdobprpd_bgd: Optional[str] = (
        None  # 분할합병일정(채권자 이의 제출기간(시작일))
    )
    dvmgsc_cdobprpd_edd: Optional[str] = (
        None  # 분할합병일정(채권자 이의 제출기간(종료일))
    )
...
class ShareExchangeDecisionData(BaseOpenDartData):
    ...
    extr_tgcmp_tisstk_ostk: Optional[int] = (
        None  # 교환ㆍ이전 대상법인(발행주식총수(주)(보통주식)) 예) 9,999,999,999
    )
    extr_tgcmp_tisstk_cstk: Optional[int] = (
        None  # 교환ㆍ이전 대상법인(발행주식총수(주)(종류주식)) 예) 9,999,999,999
    )
    rbsnfdtl_tast: Optional[int] = (
        None  # 교환ㆍ이전 대상법인(최근 사업연도 요약재무내용(원)(자산총계)) 예) 9,999,999,999
    )
    rbsnfdtl_tdbt: Optional[int] = (
        None  # 교환ㆍ이전 대상법인(최근 사업연도 요약재무내용(원)(부채총계)) 예) 9,999,999,999
    )
    rbsnfdtl_teqt: Optional[int] = (
        None  # 교환ㆍ이전 대상법인(최근 사업연도 요약재무내용(원)(자본총계)) 예) 9,999,999,999
    )
    rbsnfdtl_cpt: Optional[int] = (
        None  # 교환ㆍ이전 대상법인(최근 사업연도 요약재무내용(원)(자본금)) 예) 9,999,999,999
    )
    ...
    extrsc_shclspd_bgd: Optional[str] = (
        None  # 교환ㆍ이전일정(주주명부 폐쇄기간(시작일))
    )
    extrsc_shclspd_edd: Optional[str] = (
        None  # 교환ㆍ이전일정(주주명부 폐쇄기간(종료일))
    )
    extrsc_extrop_rcpd_bgd: Optional[str] = (
        None  # 교환ㆍ이전일정(주식교환ㆍ이전 반대의사 통지접수기간(시작일))
    )
    extrsc_extrop_rcpd_edd: Optional[str] = (
        None  # 교환ㆍ이전일정(주식교환ㆍ이전 반대의사 통지접수기간(종료일))
    )
    extrsc_gmtsck_prd: Optional[str] = None  # 교환ㆍ이전일정(주주총회 예정일자)
    extrsc_aprskh_expd_bgd: Optional[str] = (
        None  # 교환ㆍ이전일정(주식매수청구권 행사기간(시작일))
    )
    extrsc_aprskh_expd_edd: Optional[str] = (
        None  # 교환ㆍ이전일정(주식매수청구권 행사기간(종료일))
    )
    ...
    extrsc_trspprpd_bgd: Optional[str] = (
        None  # 교환ㆍ이전일정(매매거래정지예정기간(시작일))
    )
    extrsc_trspprpd_edd: Optional[str] = (
        None  # 교환ㆍ이전일정(매매거래정지예정기간(종료일))
    )
    ...
    od_a_at_b: Optional[int] = None  # 사외이사참석여부(불참(명)) 예) 9,999,999,999
    adt_a_atn: Optional[str] = (
        None  # 참석여부	감사(사외이사가 아닌 감사위원) 참석여부
    )
    popt_ctr_atn: Optional[str] = None  # 풋옵션 등 계약 체결여부
    popt_ctr_cn: Optional[str] = None  # 계약내용
    rs_sm_atn: Optional[str] = None  # 증권신고서 제출대상 여부
...
class GeneralData(BaseRegistrationData):
    ...
    aprskh_prc: Optional[str] = (
        None  # 주식매수청구권 행사 기간 및 가격((주식매수청구가격-회사제시))
    )
...
def _parse_group_items(
    ...
    for item in raw_data.get("group", []):
        ...
        if data_class:
            result[field_name] = [data_class.from_raw_data(i) for i in items]
...
class CompanySpinoffData(BaseRegistrationData):
    ...
    issued_securities: List[IssuedSecuritiesData] = field(
