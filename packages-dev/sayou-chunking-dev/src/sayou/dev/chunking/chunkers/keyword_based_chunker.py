...
class KeywordBasedChunker(BaseChunker):
    """
    Keyword-based chunker
    ...
    def __init__(self):
        self.keywords = ["Introduction", "Overview", "Conclusion", "Methods", "Challenges"]
    
    @property
    def name(self) -> str:
        return "keyword_based_chunker"
    
    def chunk(self, text: str) -> List[str]:
        # Applying Keyword-Based Chunking
        chunks = self._do_chunk(text, self.keywords)
